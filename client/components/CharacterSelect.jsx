        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] text-blue-400">{currentTempConfig.min.toFixed(1)}</span>
              <input
                type="range"
                ...
                className="flex-1 h-1.5 bg-cyber-dark rounded-lg appearance-none cursor-pointer"
                style={{
                  background: `linear-gradient(to right, #3b82f6, #06b6d4, #facc15, #ef4444)`,
                }}
              />
              <span className="text-[10px] text-red-400">{currentTempConfig.max.toFixed(1)}</span>
            </div>
          </div>
          ...
          <div className="flex-1">
            ...
            <div className="terminal-select-wrapper">
              <select
                ...
                className="terminal-select w-full text-xs p-1 bg-cyber-dark border border-neon-primary text-cyber-text"
              >
          ...
          <div className="flex items-end">
            ...
            >
              <Zap className="text-neon-primary" size={14} />
              <span className="neon-text">INIT ({currentProvider.toUpperCase()})</span>
            </button>
          </div>
        </div>
      </div>
